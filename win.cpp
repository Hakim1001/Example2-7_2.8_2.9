...
exitButton = new QPushButton(codec->toUnicode("Выход"),this);       // компоновка приложения выполняется согласно рисунку 2
...
vLayout1->addStretch();
QVBoxLayout *vLayout2 = new QVBoxLayout();                          // выравнивание по горизонтали
